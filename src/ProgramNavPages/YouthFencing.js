    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
          ...
          {data?.primaryCta?.url?.startsWith("http") ? (
            ...
            >
              ...
              <span className="relative z-10">
                {data?.primaryCta?.text || "Join Our Youth Program"}
              </span>
            </button>
          )}
          ...
          {/* Secondary CTA */}
          <button
            onClick={data?.secondaryCta ? runSecondary : () => scrollToSection("youth-programs")}
          ...
          >
            ...
            <span className="relative z-10">
              {data?.secondaryCta?.text || "View Youth Programs"}
            </span>
          </button>
        </div>
      </div>
