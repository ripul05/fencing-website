...
function CampDetailSection() {
  ...
  return (
    <section 
      className={`relative py-12 md:py-24 bg-gradient-to-b from-gray-50 via-gray-100 to-slate-200 overflow-hidden contain-layout-paint ${
        isResizing ? 'no-animations' : ''
      }`}
    >
      {/* Background patterns - mobile optimized */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 left-4 md:top-20 md:left-20 w-32 h-32 md:w-72 md:h-72 bg-gradient-to-br from-slate-200 to-gray-300 opacity-15 md:opacity-20 rounded-full"></div>
        <div className="absolute bottom-10 right-4 md:bottom-20 md:right-20 w-40 h-40 md:w-96 md:h-96 bg-gradient-to-tl from-gray-200 to-slate-300 opacity-10 md:opacity-15 rounded-full"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12 md:mb-20">
          <div className="flex items-center justify-center space-x-3 md:space-x-4 mb-6 md:mb-8 group">
            ...
            <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-amber-500 rounded-full flex items-center justify-center shadow-lg bg-white/70 backdrop-blur-lg relative group-hover:border-amber-600 transition-all duration-500">
              <div className="w-2.5 h-2.5 md:w-3 md:h-3 bg-amber-500 rounded-full animate-pulse"></div>
            </div>
            <div className="w-8 md:w-16 h-px bg-amber-500 transition-colors duration-500 group-hover:bg-amber-600"></div>
          </div>
          
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-gray-800 mb-4 md:mb-6 tracking-tight px-2">
          ...
          <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light px-4 md:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          {/* Schedule Card */}
          <div className={`bg-white/95 backdrop-blur-2xl rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-gray-200 p-4 md:p-8 text-center transition-all duration-500 group ${
            isResizing ? 'transition-none' : 'transform hover:scale-105'
          }`}>
            <div className="mb-4 md:mb-6">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center shadow-inner group-hover:shadow-lg transition-shadow duration-300">
                <svg className="w-8 h-8 md:w-10 md:h-10 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                </svg>
              </div>
            </div>
            <h3 className="text-amber-600 font-semibold text-lg md:text-xl mb-4 md:mb-6 tracking-wider border-b border-amber-200 pb-2">
              SCHEDULE
            </h3>
          ...
          <div className={`bg-white/95 backdrop-blur-2xl rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-gray-200 p-4 md:p-8 text-center transition-all duration-500 group ${
            ...
            <div className="space-y-1 md:space-y-2">
              <p className="text-3xl md:text-4xl font-bold text-gray-800">6-15</p>
              <p className="text-gray-600 font-light">Years Old</p>
              <p className="text-xs md:text-sm text-gray-500 mt-3 md:mt-4">All skill levels welcome</p>
            </div>
          </div>

          {/* Pricing Card */}
          <div className={`bg-gradient-to-br from-amber-50 to-amber-100 backdrop-blur-2xl rounded-xl md:rounded-2xl shadow-lg md:shadow-xl border border-amber-200 p-4 md:p-8 text-center transition-all duration-500 ${
            isResizing ? 'transition-none' : 'transform hover:scale-105'
          }`}>
            <div className="mb-4 md:mb-6">
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto bg-gradient-to-br from-amber-200 to-amber-300 rounded-full flex items-center justify-center shadow-inner">
                <svg className="w-8 h-8 md:w-10 md:h-10 text-amber-700" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" />
                </svg>
              </div>
            </div>
            <h3 className="text-amber-600 font-semibold text-lg md:text-xl mb-4 md:mb-6 tracking-wider border-b border-amber-300 pb-2">
              PRICING
            </h3>
            <div className="space-y-3 md:space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-gray-700 font-medium text-sm md:text-base">Camp Fee</span>
                <span className="text-amber-600 font-bold text-xl md:text-2xl">$375</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-700 font-medium text-sm md:text-base">Extended Stay</span>
                <span className="text-amber-600 font-bold text-xl md:text-2xl">$125</span>
              </div>
              <div className="pt-3 md:pt-4 border-t border-amber-300">
            ...
            <div className="space-y-2 md:space-y-3 text-left">
              {[
                ...
                <div key={index} className="flex items-center">
                  <div className="w-2 h-2 bg-amber-400 rounded-full mr-2 md:mr-3 flex-shrink-0"></div>
                  <span className="text-gray-700 text-xs md:text-sm font-light">{item}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-10 md:mt-16 text-center px-2 md:px-0">
          <div className="bg-white/90 backdrop-blur-2xl rounded-xl md:rounded-2xl shadow-lg border border-gray-200 p-6 md:p-8 max-w-4xl mx-auto">
            <h4 className="text-xl md:text-2xl font-semibold text-gray-800 mb-3 md:mb-4">What Makes Our Camp Special?</h4>
...
function GroupSection() {
  ...
  return (
    <section 
      className={`relative py-12 md:py-24 bg-gradient-to-b from-gray-100 via-gray-200 to-gray-300 overflow-hidden contain-layout-paint ${
        isResizing ? 'no-animations' : ''
      }`}
    >
      {/* Background patterns - mobile optimized */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 px-2 md:px-0">
          {[
            ...
            <div key={group.name} className="group relative overflow-hidden">
              {/* Uniform Silver Card */}
              <div className={`relative p-4 md:p-8 rounded-xl md:rounded-2xl shadow-lg cursor-pointer bg-gradient-to-br from-gray-100 to-gray-200 backdrop-blur-2xl border-2 border-gray-300 transition-all duration-500 hover:shadow-xl hover:border-amber-300 ${
                isResizing ? 'transition-none' : 'transform hover:scale-105'
              }`}>
                {/* House Icon - Silver with Amber Accent */}
                <div className="text-center mb-4 md:mb-6">
                  <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-3 md:mb-4 rounded-full flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300 shadow-lg border-2 border-amber-400 group-hover:scale-110 transition-transform duration-300">
                    <svg className="w-8 h-8 md:w-10 md:h-10 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="text-center">
                  <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-2 tracking-wider">
                    {group.name}
                  </h3>
                  <p className="text-amber-600 font-semibold text-xs md:text-sm mb-2 md:mb-3 tracking-wide">
                    HOUSE {index + 1}
                  </p>
                ...
                <div className="absolute top-3 md:top-4 right-3 md:right-4 w-6 h-6 md:w-8 md:h-8 opacity-20">
                  <div className="w-full h-full rounded-full bg-gradient-to-br from-gray-400 to-gray-500"></div>
                </div>
                <div className="absolute bottom-3 md:bottom-4 left-3 md:left-4 w-4 h-4 md:w-6 md:h-6 opacity-20">
                  <div className="w-full h-full rounded-full bg-gradient-to-br from-gray-400 to-gray-500"></div>
                </div>

                {/* Subtle Silver Hover Overlay */}
                <div className="absolute inset-0 rounded-xl md:rounded-2xl opacity-0 group-hover:opacity-10 transition-opacity duration-500 bg-gradient-to-br from-gray-300 to-gray-400"></div>
              </div>

              {/* Floating accent element */}
              <div className="absolute -top-1 -right-1 md:-top-2 md:-right-2 w-5 h-5 md:w-6 md:h-6 border-2 border-amber-300 rounded-full opacity-30 group-hover:scale-125 transition-transform duration-500 bg-gradient-to-br from-gray-200/50 to-gray-300/50"></div>
            </div>
          ))}
        </div>
        ...
        <div className="mt-10 md:mt-16 text-center px-2 md:px-0">
          <div className="bg-gradient-to-br from-gray-100 to-gray-200 backdrop-blur-2xl rounded-xl md:rounded-2xl shadow-lg border border-gray-300 p-6 md:p-8 max-w-4xl mx-auto">
            <h4 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">House Activities</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 text-left">
              <div>
                <h5 className="font-semibold text-amber-600 mb-2">Team Building</h5>
                <p className="text-gray-600 text-sm md:text-base">Collaborative exercises that strengthen bonds within each house.</p>
              </div>
              <div>
                <h5 className="font-semibold text-amber-600 mb-2">Skill Rotations</h5>
                <p className="text-gray-600 text-sm md:text-base">Houses rotate through different fencing stations throughout the day.</p>
              </div>
              <div>
                <h5 className="font-semibold text-amber-600 mb-2">Friendly Competition</h5>
                <p className="text-gray-600 text-sm md:text-base">Inter-house competitions foster healthy rivalry and motivation.</p>
              </div>
              <div>
                <h5 className="font-semibold text-amber-600 mb-2">Mentorship</h5>
                <p className="text-gray-600 text-sm md:text-base">Experienced campers help guide newcomers within their house.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center">
        ...
        <div className="overflow-hidden">
          <h2 className={`text-3xl sm:text-4xl md:text-5xl font-light text-gray-800 mb-4 md:mb-6 tracking-tight px-2 will-change-transform-opacity ${
            isResizing ? 'transition-none' : 'animate-slide-up delay-[1000ms]'
          }`}>
        ...
        <div className="overflow-hidden">
          <p className={`text-base md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light mb-10 md:mb-16 px-4 md:px-0 will-change-transform-opacity ${
        ...
        <div className={`mb-6 md:mb-8 px-4 md:px-0 will-change-transform-opacity ${
          ...
          <div className="flex items-center justify-center space-x-2 md:space-x-3 mb-3 md:mb-4">
            <div className="w-6 h-6 md:w-8 md:h-8 rounded-full bg-amber-500 flex items-center justify-center animate-pulse">
        ...
        <div className="flex flex-col gap-4 md:gap-6 justify-center mb-10 md:mb-16 px-2 md:px-0">
          {/* Camp I Button */}
          <div className={`will-change-transform-opacity ${
            isResizing ? 'transition-none' : 'animate-slide-up delay-[1800ms]'
          }`}>
            <button
              ...
              className={`
                group relative inline-flex items-center justify-center px-6 md:px-12 py-3 md:py-4 
                bg-gradient-to-r from-amber-500 to-amber-600 
                text-gray-900 font-semibold text-base md:text-lg 
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-amber-400 to-amber-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <span className="relative z-10 mr-2 md:mr-3 text-center">CAMP I - JUNE 2-6</span>
              <svg className="relative z-10 w-4 h-4 md:w-5 md:h-5 transform group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className={`will-change-transform-opacity ${
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-amber-400 to-amber-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <span className="relative z-10 mr-2 md:mr-3 text-center">CAMP II - JUNE 9-13</span>
              <svg className="relative z-10 w-4 h-4 md:w-5 md:h-5 transform group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </button>
          ...
          <div className={`will-change-transform-opacity ${
            ...
            <button
              ...
              className="
                group inline-flex items-center justify-center px-6 md:px-12 py-3 md:py-4 
                bg-gradient-to-br from-gray-100 to-gray-200 
                border-2 border-gray-300 
                text-gray-700 font-semibold text-base md:text-lg 
                rounded-xl md:rounded-2xl shadow-lg backdrop-blur-2xl
                transition 
                duration-500 ease-in-out
              ...
              "
            >
              <span className="mr-2 md:mr-3 text-center">EXTENDED STAY ADD-ON</span>
              <svg className="w-4 h-4 md:w-5 md:h-5 transform group-hover:translate-x-1 transition-transform duration-300 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </button>
          </div>
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12 md:mb-20">
          ...
          <div className="overflow-hidden">
            <p className={`text-base md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-light px-4 md:px-0 will-change-transform-opacity ${
              isResizing ? 'transition-none' : 'animate-fade-in delay-[1400ms]'
            }`}>
        ...
        {/* Enhanced Carousel Container - mobile responsive */}
        <div className="relative max-w-5xl mx-auto px-2 md:px-0">
          <div 
            className={`relative overflow-hidden rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl bg-gradient-to-br from-white to-gray-100 border-2 border-amber-200/50 will-change-transform-opacity ${
          ...
          >
            ...
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
              ...
              <div className="absolute top-3 md:top-6 right-3 md:right-6 bg-black/30 backdrop-blur-sm rounded-full px-3 py-1.5 md:px-4 md:py-2 text-white text-xs md:text-sm font-semibold">
                {currentIndex + 1} / {campImages.length}
              </div>

              {/* Navigation Arrows ON IMAGE - mobile responsive */}
              <button
                onClick={goToPrevious}
                className="absolute left-2 md:left-4 top-1/2 transform -translate-y-1/2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white p-2 md:p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-amber-400/50"
              ...
              <button
                onClick={goToNext}
                className="absolute right-2 md:right-4 top-1/2 transform -translate-y-1/2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white p-2 md:p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-amber-400/50"
          ...
          <div className="flex justify-center space-x-2 md:space-x-3 mt-6 md:mt-8">
            {campImages.map((_, index) => (
              <button
                ...
                className={`
                  w-3 h-3 md:w-4 md:h-4 rounded-full transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-amber-400/50
                  ${index === currentIndex 
          ...
          <div className="hidden md:flex justify-center space-x-3 lg:space-x-4 mt-6 lg:mt-8 overflow-x-auto pb-4">
            {campImages.map((image, index) => (
              <button
                key={index}
                onClick={() => goToSlide(index)}
                className={`
                  relative flex-shrink-0 w-16 h-16 lg:w-20 lg:h-20 rounded-lg lg:rounded-xl overflow-hidden transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-amber-400/50
                  ${index === currentIndex 
                    ? 'ring-3 lg:ring-4 ring-amber-500 scale-110 shadow-xl' 
